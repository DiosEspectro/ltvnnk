...
public class SuperClassN3 {
    public int superint;

    SuperClassN3(){}

    SuperClassN3(int valueEx){
        this.setValue(valueEx);
    }

    public void setValue(int valueExInt) {
        this.superint = valueExInt;
    }

    @Override
    public String toString() {
        return getClass().getSimpleName() + ": superint = " + superint;
    }
}
